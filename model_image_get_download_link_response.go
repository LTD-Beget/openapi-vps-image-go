...
// checks if the ImageGetDownloadLinkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageGetDownloadLinkResponse{}
...
func (o ImageGetDownloadLinkResponse) ToMap() (map[string]interface{}, error) {
