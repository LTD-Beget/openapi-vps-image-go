...
// checks if the ImageImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageImage{}
...
func (o ImageImage) ToMap() (map[string]interface{}, error) {
