...
// checks if the ImageImageSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageImageSource{}
...
func (o ImageImageSource) ToMap() (map[string]interface{}, error) {
