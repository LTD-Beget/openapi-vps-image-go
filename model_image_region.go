...
// checks if the ImageRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageRegion{}
...
func (o ImageRegion) ToMap() (map[string]interface{}, error) {
